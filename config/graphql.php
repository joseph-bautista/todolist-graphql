...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'activity' => App\GraphQL\Queries\Activity\ActivityQuery::class,
                'activities' => App\GraphQL\Queries\Activity\ActivitiesQuery::class,
                'user' => App\GraphQL\Queries\User\UserQuery::class,
                'users' => App\GraphQL\Queries\User\UsersQuery::class,
            ],
            'mutation' => [
                // ExampleMutation::class,
                'createActivity' => App\GraphQL\Mutations\Activity\CreateActivityMutation::class,
                'updateActivity' => App\GraphQL\Mutations\Activity\UpdateActivityMutation::class,
                'deleteActivity' => App\GraphQL\Mutations\Activity\DeleteActivityMutation::class,
